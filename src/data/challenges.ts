...
export const CHALLENGES: Challenge[] = [
  {
    ...
    industryIds: ['manufacturing', 'energy-resources', 'retail', 'telecommunications', 'healthcare-provider', 'government', 'mobility-travel'],
    pillarId: 'reshape',
  },
  {
    ...
    industryIds: ['retail', 'banking', 'insurance', 'telecommunications', 'mobility-travel', 'media-entertainment', 'consumer-goods', 'manufacturing', 'professional-services'],
    pillarId: 'reinvent',
  },
  {
    id: 'revenue-growth',
  ...
  },
  {
    ...
    industryIds: ['banking', 'capital-markets', 'government', 'healthcare-provider', 'healthcare-medtech', 'insurance', 'energy-resources', 'manufacturing'],
    pillarId: 'security',
  },
  {
    id: 'data-analytics',
  ...
  },
  {
    ...
    industryIds: ['professional-services', 'healthcare-provider', 'higher-education', 'government', 'manufacturing', 'retail', 'banking', 'insurance', 'capital-markets', 'telecommunications', 'energy-resources'],
    pillarId: 'enrich',
  },
  {
    id: 'innovation-speed',
  ...
  },
  {
    ...
    industryIds: ['manufacturing', 'energy-resources', 'retail', 'mobility-travel', 'telecommunications', 'government', 'insurance', 'banking', 'capital-markets', 'professional-services', 'healthcare-provider'],
    pillarId: 'reshape',
  },
  {
    id: 'sustainability',
  ...
  },
  {
    ...
    industryIds: ['banking', 'government', 'insurance', 'healthcare-provider', 'manufacturing', 'higher-education'],
    pillarId: 'reshape',
  },
  {
    id: 'supply-chain',
  ...
  },
  {
    ...
    industryIds: ['professional-services', 'higher-education', 'media-entertainment', 'government', 'healthcare-provider', 'insurance', 'banking', 'manufacturing', 'energy-resources'],
    pillarId: 'enrich',
  },
  {
    id: 'risk-management',
    ...
    industryIds: ['banking', 'capital-markets', 'insurance', 'energy-resources', 'healthcare-medtech', 'government'],
    pillarId: 'security',
  },
  {
    id: 'patient-outcomes',
